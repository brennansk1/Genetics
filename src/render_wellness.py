...
def render_wellness_profile(dna_data):
    ...
    with st.expander("Click to see beginner-friendly definitions of genetic terms"):
        ...
        st.write("**Gene**: A segment of DNA that acts like a recipe for making proteins your body needs.")
        st.write("**Interpretation**: What your genotype might mean for your health or traits.")
    ...
    if st.button("Analyze Wellness & Traits"):
        ...
        st.subheader("What Does This Mean?")
        st.write("**Genetic Exercise Blueprint**: Your DNA influences whether you're naturally better suited for sprinting (power-based activities) or endurance activities (like long-distance running). This is like having a genetic predisposition for certain types of physical activities, but training and lifestyle still play major roles.")
        st.write("While genetics provide a foundation, everyone can improve their fitness through consistent training, proper nutrition, and recovery.")
        ...
        st.subheader("What Does This Mean?")
        st.write("**Methylation as Chemical Tags**: Think of methylation as adding chemical 'tags' to your DNA that can turn genes on or off. The COMT gene helps regulate these tags, affecting how your body processes stress, pain, and even certain nutrients. Variations can influence your sensitivity to caffeine and stress responses.")
        st.write("Methylation is a fundamental process that affects many aspects of health, from detoxification to neurotransmitter regulation.")
        ...
        st.subheader("What Does This Mean?")
        st.write("**Genetic Quirks as Unique Features**: These traits show how genetics can influence everyday experiences that make you uniquely you. From how food tastes to reflex reactions, these variants highlight the diversity of human genetic variation.")
        st.write("While these traits are 'quirky,' they demonstrate how genetics influence our sensory experiences and automatic responses.")
