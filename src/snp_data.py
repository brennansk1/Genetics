...
star_allele_definitions = {
    "CYP2C19": {
        "*1": {
            "haplotypes": [],
            "function": "Normal",
            "description": "Reference haplotype",
        },
        "*2": {
            "haplotypes": ["rs4244285:A"],
            "function": "No function",
            "description": "681G>A",
        },
        "*3": {
            "haplotypes": ["rs4986893:A"],
            "function": "No function",
            "description": "636G>A",
        },
        "*17": {
            "haplotypes": ["rs12248560:T"],
            "function": "Increased function",
            "description": "-806C>T",
        },
        "*4": {
            "haplotypes": ["rs28399504:A"],
            "function": "No function",
            "description": "1A>C",
        },
        "*5": {
            "haplotypes": ["rs56337013:C"],
            "function": "No function",
            "description": "1297C>T",
        },
        "*6": {
            "haplotypes": ["rs72552267:A"],
            "function": "No function",
            "description": "395G>A",
        },
        "*7": {
            "haplotypes": ["rs72558186:A"],
            "function": "No function",
            "description": "19294T>A",
        },
        "*8": {
            "haplotypes": ["rs41291556:T"],
            "function": "No function",
            "description": "358T>C",
        },
        "*9": {
            "haplotypes": ["rs17884712:G"],
            "function": "No function",
            "description": "431G>A",
        },
        "*10": {
            "haplotypes": ["rs6413438:T"],
            "function": "No function",
            "description": "680C>T",
        },
    },
    "CYP2D6": {
        ...
        "*3": {
            "haplotypes": ["rs35742686:delA"],
            "function": "No function",
            "description": "2549delA",
        },
        "*4": {
            "haplotypes": ["rs3892097:A", "rs1065852:T", "rs28371725:C"],
            "function": "No function",
            "description": "1846G>A + 100C>T + 4180G>C",
        },
        "*5": {
            "haplotypes": ["deletion"],
            "function": "No function",
        ...
        "*6": {
            "haplotypes": ["rs5030655:delT", "rs3892097:A"],
            "function": "No function",
            "description": "1707delT + 1846G>A",
        },
        "*10": {
            "haplotypes": ["rs1065852:T", "rs1135840:C"],
            "function": "Decreased function",
            "description": "100C>T + 1661G>C",
        },
        "*17": {
            "haplotypes": ["rs28371706:T", "rs16947:T", "rs28371725:C"],
            "function": "Decreased function",
            "description": "1023C>T + 886C>T + 4180G>C",
        },
        "*41": {
            "haplotypes": ["rs28371725:C", "rs16947:T", "rs267608319:T"],
            "function": "Decreased function",
            "description": "4180G>C + 886C>T + 2988G>A",
        },
    },
    "CYP2C9": {
        "*1": {
        ...
        "*2": {
            "haplotypes": ["rs1799853:C"],
            "function": "Decreased function",
            "description": "430C>T",
        },
        "*3": {
            "haplotypes": ["rs1057910:A"],
            "function": "Decreased function",
            "description": "1075A>C",
        },
    },
    "TPMT": {
        ...
        "*2": {
            "haplotypes": ["rs1800462:A"],
            "function": "No function",
            "description": "238G>C",
        },
        "*3A": {
            "haplotypes": ["rs1800460:A", "rs1142345:T"],
            "function": "No function",
            "description": "460G>A + 719A>G",
        },
        "*3B": {
            "haplotypes": ["rs1800460:A"],
            "function": "No function",
            "description": "460G>A",
        },
        "*3C": {
            "haplotypes": ["rs1142345:T"],
            "function": "No function",
            "description": "719A>G",
        },
    },
    "DPYD": {
        ...
        "*2A": {
            "haplotypes": ["rs3918290:T"],
            "function": "No function",
            "description": "1905+1G>A",
        },
        "*13": {
            "haplotypes": ["rs55886062:A"],
            "function": "Decreased function",
            "description": "1679T>G",
        },
    },
...
prs_models = {
    ...
    "ADHD": {
        "genomewide_models": [{"pgs_id": "PGS000038", "description": "ADHD GWAS"}],
        "category": "Mental Health",
...
def get_prs_models_by_category(category):
    ...
    return {
        name: model
        for name, model in prs_models.items()
...
guidance_data = {
    ...
    "Atrial Fibrillation": {
        ...
        "medical": [
            "Anticoagulation therapy if indicated",
    ...
    "Inflammatory Bowel Disease": {
        ...
        "medical": [
            ...
            "Regular gastroenterology follow-up",
    ...
    "Major Depressive Disorder": {
        ...
        "medical": [
            "Antidepressant therapy if indicated",
    ...
    "Asthma": {
        ...
        "medical": [
            ...
            "Rescue inhaler use",
            "Regular allergy/pulmonary follow-up",
        ],
